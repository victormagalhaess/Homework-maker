...
It can generate pretty nice homeworks, as you can see in the examples folder. (it's currently an example in portuguese)
In february 2020 Google changed how the images are retrieved and the library that downloads images for the homeworks broke. The program still works pretty nice, just can't download the images. Sorry fot this.
